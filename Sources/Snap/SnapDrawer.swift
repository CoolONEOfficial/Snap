...
public struct SnapDrawer<StateType: SnapState, Background : View, Content: View> : View {
    ...
    public var body: some View {
        ...
        return ZStack {
            currentResult.state.visible.map { background($0).edgesIgnoringSafeArea(.container, edges: [ .vertical, .horizontal ]) }
        ...
        .shadow(color: Color(.sRGBLinear, white: 0, opacity: 0.5), radius: 20.0)
